...
TOKENIZER_MAP = {'mtspace': MTSpaceTokenizer, 'multitask': MultiTaskTokenizer, 'wikilarge': WikiLargeTokenizer}
...
def main():
    ...
    indexer = tokenizer(args.base_dir, args.prefix, vocab_size=args.vocab_size,
